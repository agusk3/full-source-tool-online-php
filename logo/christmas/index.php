...
echo '<div class="list1"><center><img src="view.php?text='.(isset($_POST['text']) ? ''.htmlentities($_POST['text']).'':'S2VN.TOP').'&color='.(isset($_POST['color']) ? ''.htmlentities($_POST['color']).'':'3').'&font='.(isset($_POST['font']) ? ''.htmlentities($_POST['font']).'':'5').'" alt="logo" /><br><a href ="view.php?text='.(isset($_POST['text']) ? ''.htmlentities($_POST['text']).'':'S2VN.TOP').'&color='.(isset($_POST['color']) ? ''.htmlentities($_POST['color']).'':'3').'&font='.(isset($_POST['font']) ? ''.htmlentities($_POST['font']).'':'5').'" />[Tải về]</a></center> ';
